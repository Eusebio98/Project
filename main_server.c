...
/* IMPORTANT --> THIS PROGRAM MUST BE RUN WITH SUDO COMMAND BECAUSE ONLY SYSTEM ADMINISTRATOR CAN UPLOAD FILE IN /home
   OTHERWISE CLIENT WILL DETECT AN ERROR IN UPLOAD FUNCTION, ALSO THE FILE CONTAINING THE PERMISSIONS FOR ACCESS TO THE
   SERVER /home/user_pass.txt TO BE CREATED AND BE READ IN /home NEEDS ROOT PERMISSIONS (WITH SUDO COMMAND). */
